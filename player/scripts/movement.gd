...
func _ready() -> void:
	...
	$CanvasLayer/MarginContainer/ObjectSpawn.connect("object_menu_opened", pause_movement)
	$CanvasLayer/MarginContainer/ObjectSpawn.connect("object_menu_closed", unpause_movement)
